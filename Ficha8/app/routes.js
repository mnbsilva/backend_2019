module.exports = function(app, passport) {
    ...
    app.post ('/login', passport.authenticate('local-login', {
        ...
        failureRedirect : '/login', // redirect back to the signature if there is an error
    ...
    app.get('/signup', function(req, res) {
        res.render('signup.ejs', {message: "signup"}); // load the index.ejs file
    });
    ...
    app.post ('/signup', passport.authenticate('local-signup', {
        sucessRedirect : '/profile', // redirect to the secure profile section
        failureRedirect : '/signup', // redirect back to the signature if there is an error
        failureFlash : true // allow flash messages
    }));
